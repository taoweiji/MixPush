...
dependencies {
    implementation 'com.mixpush:mixpush-core:2.0.5'// 核心包
    implementation 'com.mixpush:mixpush-mi:2.0.5' // 小米推送
    implementation 'com.mixpush:mixpush-meizu:2.0.5' // 魅族推送
    implementation 'com.mixpush:mixpush-huawei:2.0.5' // 华为推送
    implementation 'com.mixpush:mixpush-oppo:2.0.5' // OPPO推送
    implementation 'com.mixpush:mixpush-vivo:2.0.5' // VIVO推送
}
```
